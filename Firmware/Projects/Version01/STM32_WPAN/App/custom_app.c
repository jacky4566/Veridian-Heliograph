...
void Custom_STM_App_Notification(Custom_STM_App_Notification_evt_t *pNotification)
{
  ...
  /* LocationService */
    case CUSTOM_STM_LNF_READ_EVT:
      /* USER CODE BEGIN CUSTOM_STM_LNF_READ_EVT */

      /* USER CODE END CUSTOM_STM_LNF_READ_EVT */
      break;

    case CUSTOM_STM_LSC_READ_EVT:
      /* USER CODE BEGIN CUSTOM_STM_LSC_READ_EVT */

      /* USER CODE END CUSTOM_STM_LSC_READ_EVT */
      break;
