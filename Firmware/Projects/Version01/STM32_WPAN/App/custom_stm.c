...
typedef struct{
  ...
  uint16_t  CustomOtabrHdle;                  /**< OTABootRequest handle */
}CustomContext_t;
...
static const uint8_t SizeOtabr=3;
/**
...
#define COPY_OTABOOTREQUEST_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x11,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      ...
      switch(blecore_evt->ecode)
      {
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
          ...
          if(attribute_modified->Attr_Handle == (CustomContext.CustomOtabrHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
        ...
        case ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE:
          ...
          if(write_perm_req->Attribute_Handle == (CustomContext.CustomOtabrHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   *  OTABootRequest
   */
  COPY_OTABOOTREQUEST_UUID(uuid.Char_UUID_128);
